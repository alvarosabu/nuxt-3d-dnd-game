...
export function getNode(spec: typeof SceneScene.Rig.Arms_Base): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Ear_Pointy_Straight): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Earing_TwoRings_Left): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Eyebrows_Thick): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Eyes_Base): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Hair_EyriePeak): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Head_Male): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Horns_Ruin_Curves): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.Nose_Base): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.ScaleMail_Boots): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.ScaleMail_Gloves): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Rig.ScaleMail_Male): Promise<SkinnedMesh>;
